      ...
      <div className="about-content fade-in">
        ...
        <div className="mission-container" id="container-reverse">
          <div className="mission-section">
            <img id="mission-bullet" src={getImagePath("/images/blueberry_bullet.png")} alt="Bullet Point" />
            <p>
          ...
          <div className="mission-section">
            <img id="mission-bullet" src={getImagePath("/images/lemon_bullet.png")} alt="Bullet Point" />
            <p>
          ...
          <div className="mission-section">
            <img id="mission-bullet" src={getImagePath("/images/tomato_bullet.png")} alt="Bullet Point" />
            <p>
          ...
          <div className="mission-section">
            <img id="mission-bullet" src={getImagePath("/images/orange_bullet.png")} alt="Bullet Point" />
            <p>
        ...
        <img id="mission-image" src={getImagePath("/images/farmers_market_stand.png")} alt="Image that says Thanks for visiting!" />
      </div>
    </>
  );
};
